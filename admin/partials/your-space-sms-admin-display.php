    ...
    <table class="form-table" role="presentation">
        <tbody>
            <tr class="form-field form-required term-name-wrap">
                ...
                <td>
                    <select name="<?= $this->plugin_name; ?>-type" x-model="type" class="postform">
                        <option value="">Please select</option>
                        <option value="woocommerce">WooCommerce</option>
                        <option value="contactform">Contact Form</option>
                    </select>
                    <p class="description">The plugin/object this event is attached to.</p>
                </td>
            </tr>
            <tr class="form-field term-slug-wrap" x-show="type==='woocommerce'">
                <th scope="row">
                    <label>Woocommerce Event</label>
                </th>
                <td>
                    <select name="<?= $this->plugin_name; ?>-woo-action" x-model="wooAction" class="postform">
                        <option value="">Please select</option>
                    ...
                    <p class="description">The event on which this SMS is send.</p>
                </td>
            </tr>
            <tr class="form-field term-slug-wrap" x-show="type==='contactform'">
                ...
                <td>
                    <select name="<?= $this->plugin_name; ?>-contactform-item" x-model="contactformItem" class="postform">
                        <option value="">Please select</option>
                        <?php
                    ...
                    <p class="description">SMS will be sent on submission of this form.</p>
                </td>
            </tr>
            <tr class="form-field term-slug-wrap" x-show="wooAction||contactformItem">
                ...
                <td>
                    <select name="<?= $this->plugin_name; ?>-send-to" x-model="sendTo" class="postform">
                        <option value="user">User</option>
                        <option value="agent">Agent</option>
                    </select>
                    <p class="description">The SMS can be sent to either the user or an agent.</p>
                </td>
            </tr>
            <tr class="form-field term-slug-wrap" x-show="(wooAction||contactformItem)&& sendTo&&sendTo=='agent'">
                ...
                <td>
                    <input name="<?= $this->plugin_name; ?>-agent-phone" x-model="agentPhone" type="tel" size="40">
                    <p class="description">This SMS will be sent to this phone number.</p>
                </td>
            </tr>
            <tr class="form-field term-slug-wrap" x-show="(wooAction||contactformItem)&& sendTo">
                ...
                <td>
                    <textarea name="<?= $this->plugin_name; ?>-sms-body" cols="90" rows="4" x-model="smsBody" class="postform"></textarea>
                    <p class="description">
                        SMS character limit: <span x-text="`${smsBody.length}/160`"></span>. 
                        Use <code>%%</code> for variables. Example: <code>Hello %name%.</code>
                    </p>
                </td>
            </tr>
        </tbody>
